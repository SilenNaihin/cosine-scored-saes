"""
Experiment 43c: 50M token 4-architecture comparison at L9 (saprmarks recipe)
==============================================================================

L9 is early depth with low activation norms (~58). Historically the "clean
comparison" layer where init issues don't interfere. Tests whether cosine
variants maintain sparse probing advantage at shallow depth.
...
Run on <gpu-server> GPU 0:
    ...
    CUDA_VISIBLE_DEVICES=0 PYTHONUNBUFFERED=1 nohup python3 experiments/exp43c_50m_l9.py \
        2>&1 | tee experiments/exp43c_output.log &
"""
...
SAVE_DIR = Path("/mnt/nvme0/checkpoints/exp43c")
RESULTS_PATH = Path("experiments/exp43c_results.json")
